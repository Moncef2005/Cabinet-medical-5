    ...
    <div class="sidebar-brand">
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                ...
                <span>{{ ucfirst(auth()->user()->role_label) }}</span>
            </div>
        </div>
    </div>
        ...
        <div class="d-flex align-items-center gap-3">
                ...
                <div class="dropdown-menu dropdown-menu-end" style="width:300px; max-height:400px; overflow-y:auto;">
                    ...
                    @forelse(auth()->user()->unreadNotifications->take(5) as $notif)
                        <a class="dropdown-item py-2" href="#">
                            <div class="fw-semibold" style="font-size:0.85rem">{{ $notif->data['message'] ?? '' }}</div>
            ...
            <div class="dropdown">
                <button class="btn btn-sm d-flex align-items-center gap-2" data-bs-toggle="dropdown">
                    ...
                    <span class="d-none d-md-inline text-dark fw-semibold" style="font-size:0.85rem">{{ auth()->user()->name }}</span>
                    <i class="bi bi-chevron-down text-muted" style="font-size:0.7rem"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    <div class="px-3 py-2 text-muted" style="font-size:0.8rem">{{ auth()->user()->email }}</div>
