        ...
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span style="font-size:.875rem">{{ \Illuminate\Support\Str::limit($appt->reason, 30) }}</span></td>
                    <td>
...
const apptData   = @json($appointmentsChart);
...
// ─── Specialty Pie Chart ───────────────────────────────────────
const specialtyData = @json($specialtyChart);
