...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Authentification'); ?> | Cabinet Médical</title>
...
<body>
    <div class="auth-card">
        <div class="text-center mb-4">
            ...
            <p class="subtitle"><?php echo $__env->yieldContent('subtitle', 'Accès sécurisé au système de gestion'); ?></p>
        </div>
...
<?php /**PATH C:\Users\HP\Downloads\cabinet-medical-final\cabinet-medical\resources\views/layouts/guest.blade.php ENDPATH**/ ?>